...
end entity lfsr_counter_tb;

architecture tb of lfsr_counter_tb is
  constant c_clk_period : time := 10 ns;

  constant g_state : std_logic_vector(64 - 1 downto 0) := bin_to_slv(g_seed);
...
begin
  ...
  lfsr_counter_inst : entity lib_counter.lfsr_counter
    generic map(
      g_size  => g_size,
      g_state => g_state
    )
